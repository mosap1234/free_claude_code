...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "Tuning Engines API Key",
        "providers",
        "secret",
        settings_attr="tuning_engines_api_key",
        secret=True,
        description="Tuning Engines inference API key.",
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
        "LM Studio Base URL",
    ...
    ConfigFieldSpec(
        "TUNING_ENGINES_PROXY",
        "Tuning Engines Proxy",
        "providers",
        "secret",
        settings_attr="tuning_engines_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
