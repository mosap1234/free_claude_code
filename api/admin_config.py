...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="openai_compat_api_key",
        secret=True,
        description="API key for a generic OpenAI-compatible endpoint (vLLM, SGLang, TGI, LiteLLM, ...).",
    ),
    ConfigFieldSpec(
        "OPENAI_COMPAT_BASE_URL",
        "OpenAI-Compatible Base URL",
        "providers",
        settings_attr="openai_compat_base_url",
        default="http://localhost:8000/v1",
        description="Base URL of the OpenAI-compatible /v1 endpoint.",
    ),
    ConfigFieldSpec(
        "NVIDIA_NIM_PROXY",
        "NVIDIA NIM Proxy",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="openai_compat_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
