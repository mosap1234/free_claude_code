...
- 18 provider backends: NVIDIA NIM, OpenRouter, Google AI Studio (Gemini), DeepSeek, Mistral La Plateforme, Mistral Codestral, OpenCode Zen, OpenCode Go, Wafer, Kimi, Cerebras Inference, Groq, Fireworks AI, Z.ai, LM Studio, llama.cpp, and Ollama, and OpenAI.
...
### 18. [OpenAI](https://platform.openai.com/)
...
- NIM, OpenCode Zen, OpenCode Go, and OpenAI use OpenAI chat streaming translated into Anthropic SSE.
