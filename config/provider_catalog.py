...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "open_router": ProviderDescriptor(
        ...
        base_url_attr="open_router_base_url",
    ...
    "mistral_codestral": ProviderDescriptor(
        ...
        base_url_attr="codestral_base_url",
    ...
    "opencode": ProviderDescriptor(
        ...
        base_url_attr="opencode_base_url",
    ...
    "zai": ProviderDescriptor(
        ...
        # Intentionally pinned (no base_url_attr): the Z.ai Anthropic-compat
        # endpoint is exact, and a stale ZAI_BASE_URL must not override it.
        # See tests/providers/test_registry.py::test_zai_descriptor_uses_fixed_cloud_base_url.
