...
def _create_tuning_engines(config: ProviderConfig, _settings: Settings) -> BaseProvider:
    from providers.tuning_engines import TuningEnginesProvider

    return TuningEnginesProvider(config)
...
PROVIDER_FACTORIES: dict[str, ProviderFactory] = {
    ...
    "tuning_engines": _create_tuning_engines,
}
